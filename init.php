 ...
 * Github Plugin URI: dbiagi/wordpress_disable_users
 *
...
final class ja_disable_users {
	...
	public function user_login( $user_login, $user = null ) {
		...
		if ( $disabled == '1' ) {
			...
			$login_url = site_url( 'minha-conta', 'login' );
	...
	public function manage_users_css() {
		echo '<style type="text/css">.column-ja_user_disabled { width: 100px; }</style>';
	}
}
